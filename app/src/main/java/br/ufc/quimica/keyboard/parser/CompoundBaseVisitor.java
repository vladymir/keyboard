...
/**
 * This class provides an empty implementation of {@link CompoundVisitor},
 ...
 */
public class CompoundBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CompoundVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
